    ...
    <div class="container">
        <div class="intro cta-inner bg-faded text-center rounded">
            <h2 class="section-heading text-center mb-4">
                <span class="section-heading-lower"><strong>Are you sure you want to delete this user?</strong></span>
            </h2>
                ...
                <div class="col-lg-6">
                    <form method="POST">
                        <div class="text-center">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="detail.php?id=<?php echo $user['ID'] ?>" class="btn btn-primary btn-xl"><strong>Cancel</strong></a>
                        </div>
                    </form>
                </div>
            </div>
