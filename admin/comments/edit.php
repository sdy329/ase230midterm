...
if(count($_POST) > 0){
    if(isset($_POST['comment'])){
        query('UPDATE comments SET comment = ? WHERE ID = ?', [$_POST['comment'], $_POST['id']]);
                    ...
                    <form method="POST">
                        <div class="text-center">
                            <div class="mb-3">
                                ...
                                <textarea type="text" class="form-control" id="comment" name="comment" required><?=$comment['comment']?></textarea>
                            </div>
