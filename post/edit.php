...
if(count($_POST) > 0){
    if(isset($_POST['title']) && isset($_POST['content']) && isset($_SESSION['id'])){
        ...
        query('UPDATE posts SET title = ?, content = ?, postedDateTime = ? WHERE ID = ?', [$title, $content, $dateTime, $postID]);
    ...
    <div class="container">
        <div class="intro cta-inner bg-faded text-center rounded">
            <h2 class="section-heading text-center mb-4">
                <span class="section-heading-lower"><strong>Edit Your Post</strong></span>
            </h2>
                ...
                <div class="col-lg-6">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="content" name="content" required><?= $postData['content'] ?></textarea>
                        </div>
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary btn-xl"><strong>Edit Post</strong></button>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="index.php?id=<?php echo $postID; ?>" class="btn btn-primary btn-xl"><strong>Cancel</strong></a>
                        </div>
                    </form>
                </div>
            </div>
